        ...
        <>
            ...
            <section className="px-6 w-full md:px-8 md:pt-36 rounded-2xl bg-white dark:bg-black">
                <div ref={scrollContainer} className="relative w-full flex gap-8 justify-start overflow-x-auto h-fit snap-x snap-mandatory rounded-2xl">
                    ...
                    <HeroSection id={2} image={"/OSSKreaFlux1_poster.webp"} title="WAN 2.2 Image generation" text="Generate complex images with the brand new and powerful WAN 2.2 model. Exceptional prompt adherence and ultra-realistic textures." height={1440} onVisible={ setVisible } />
                    <HeroSection id={3} image={"/quick-action-hold-product.webp"} title="WAN 2.2 Image generation" text="Generate complex images with the brand new and powerful WAN 2.2 model. Exceptional prompt adherence and ultra-realistic textures." height={1067}  onVisible={ setVisible } />
                    <HeroSection id={4} image={"/e06d7a87-e1de-4910-9083-7be5986b45f0_512.webp"} title="WAN 2.2 Image generation" text="Generate complex images with the brand new and powerful WAN 2.2 model. Exceptional prompt adherence and ultra-realistic textures." height={1440}  onVisible={ setVisible } />
                    <HeroSection id={5} image={"/3c1008da-78a1-486e-8cb4-60484c37016a.webp"} title="WAN 2.2 Image generation" text="Generate complex images with the brand new and powerful WAN 2.2 model. Exceptional prompt adherence and ultra-realistic textures." height={1067}  onVisible={ setVisible } />
                    <HeroSection id={6} image={"/quick-action-remove-text.webp"} title="WAN 2.2 Image generation" text="Generate complex images with the brand new and powerful WAN 2.2 model. Exceptional prompt adherence and ultra-realistic textures." height={1440}  onVisible={ setVisible } />
                    ...
                    <HeroSection id={8} image={"/astronautshirt.jpeg"} title="WAN 2.2 Image generation" text="Generate complex images with the brand new and powerful WAN 2.2 model. Exceptional prompt adherence and ultra-realistic textures." height={1440}  onVisible={ setVisible } />
                </div>
            </section>
