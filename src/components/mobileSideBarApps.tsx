...
type MobileSideBarAppsProps = {
    title: string;
    image: string;
}
export function MobileSideBarApps ({ title, image}: MobileSideBarAppsProps ) {
    return (
        <div className="flex flex-row justify-between items-center">
            <Link prefetch={false} href={"#"} className="text-black dark:text-white flex gap-2 items-center">
                <div className="mobileSideBarApps relative bg-primary-150/15 dark:bg-primary-850/15 p-2 rounded-[10px] dark:text-primary-150">
                    ...
                    <Image src={`/generate-icons/${image}`} className="w-7" width={84} height={84} alt="" />
                </div>
